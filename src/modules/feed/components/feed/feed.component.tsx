...
import { ArticleList } from '../article-list/acticle-list.component';
    ...
    <>
      ...
      <nav className='my-6'>
        <ReactPaginate 
          ...
          pageClassName='group'
          pageLinkClassName='p-3 text-conduit-green bg-white border border-conduit-gray-400 -ml-px group-[&:nth-child(2)]:rounded-l hover:bg-conduit-gray-200'
